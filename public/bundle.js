...
document.addEventListener("DOMContentLoaded", function () {
  ...
  .attr('cx', gameWidth / 2).attr('cy', gameHeight - 300).attr("id", "shield").attr("transform", "translate(-25, -25)").attr("xlink:href", "./public/images/shield.svg.png");
  ...
  .attr('cx', gameWidth / 2).attr('cy', gameHeight - characterR - 30).attr("id", "character").attr("transform", "translate(-30, -30)").attr("xlink:href", "./public/images/icons8-minion-50.png");
